...
const TermsConditions: React.FC = () => {
    return (
        <div className="min-h-screen">
            <Seo title="Terms & Conditions" description="The terms and conditions that govern use of the Intrepid Technology website and engagement of our services." />
            {/* Hero Section */}
            ...
            <section className="py-20 bg-white dark:bg-slate-950">
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="prose prose-lg max-w-none dark:prose-invert">
                        ...
                        <h2 className="text-2xl font-bold text-slate-900 dark:text-white mb-6">2. Description of Service</h2>
                        ...
                        <h2 className="text-2xl font-bold text-slate-900 dark:text-white mb-6">3. User Responsibilities</h2>
                        <p className="text-slate-600 dark:text-slate-300 mb-4">
                        ...
                        <h2 className="text-2xl font-bold text-slate-900 dark:text-white mb-6">4. Project Terms</h2>
                        <div className="mb-8">
                            <h3 className="text-xl font-semibold text-slate-900 dark:text-white mb-4">4.1 Project Scope</h3>
                            <p className="text-slate-600 dark:text-slate-300 mb-4">
                        ...
                        <div className="mb-8">
                            <h3 className="text-xl font-semibold text-slate-900 dark:text-white mb-4">4.2 Payment Terms</h3>
                            <p className="text-slate-600 dark:text-slate-300 mb-4">
                        ...
                        <h2 className="text-2xl font-bold text-slate-900 dark:text-white mb-6">5. Intellectual Property Rights</h2>
                        <div className="mb-8">
                            <h3 className="text-xl font-semibold text-slate-900 dark:text-white mb-4">5.1 Client Ownership</h3>
                            <p className="text-slate-600 dark:text-slate-300 mb-4">
                        ...
                        <div className="mb-8">
                            <h3 className="text-xl font-semibold text-slate-900 dark:text-white mb-4">5.2 Intrepid Technology Rights</h3>
                            <p className="text-slate-600 dark:text-slate-300 mb-4">
                        ...
                        <h2 className="text-2xl font-bold text-slate-900 dark:text-white mb-6">6. Confidentiality</h2>
                        <p className="text-slate-600 dark:text-slate-300 mb-8">
                        ...
                        <h2 className="text-2xl font-bold text-slate-900 dark:text-white mb-6">7. Limitation of Liability</h2>
                        <p className="text-slate-600 dark:text-slate-300 mb-8">
                        ...
                        <h2 className="text-2xl font-bold text-slate-900 dark:text-white mb-6">8. Warranty and Support</h2>
                        <div className="mb-8">
                            <h3 className="text-xl font-semibold text-slate-900 dark:text-white mb-4">8.1 Warranty Period</h3>
                            <p className="text-slate-600 dark:text-slate-300 mb-4">
                        ...
                        <div className="mb-8">
                            <h3 className="text-xl font-semibold text-slate-900 dark:text-white mb-4">8.2 Support Services</h3>
                            <p className="text-slate-600 dark:text-slate-300 mb-4">
                        ...
                        <h2 className="text-2xl font-bold text-slate-900 dark:text-white mb-6">9. Termination</h2>
                        <p className="text-slate-600 dark:text-slate-300 mb-8">
                        ...
                        <h2 className="text-2xl font-bold text-slate-900 dark:text-white mb-6">10. Force Majeure</h2>
                        <p className="text-slate-600 dark:text-slate-300 mb-8">
                        ...
                        <h2 className="text-2xl font-bold text-slate-900 dark:text-white mb-6">11. Governing Law</h2>
                        <p className="text-slate-600 dark:text-slate-300 mb-8">
                        ...
                        <h2 className="text-2xl font-bold text-slate-900 dark:text-white mb-6">12. Changes to Terms</h2>
                        <p className="text-slate-600 dark:text-slate-300 mb-8">
                        ...
                        <h2 className="text-2xl font-bold text-slate-900 dark:text-white mb-6">13. Contact Information</h2>
                        <p className="text-slate-600 dark:text-slate-300 mb-4">
