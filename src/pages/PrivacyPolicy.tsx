...
const PrivacyPolicy: React.FC = () => {
    return (
        <div className="min-h-screen">
            <Seo title="Privacy Policy" description="How Intrepid Technology collects, uses and protects personal information submitted through our website and services." />
            {/* Hero Section */}
            ...
            <section className="py-20 bg-white dark:bg-slate-950">
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="prose prose-lg max-w-none dark:prose-invert">
                        ...
                        <div className="mb-8">
                            <h3 className="text-xl font-semibold text-slate-900 dark:text-white mb-4">Automatically Collected Information</h3>
                            <p className="text-slate-600 dark:text-slate-300 mb-4">
                        ...
                        <h2 className="text-2xl font-bold text-slate-900 dark:text-white mb-6">3. Information Sharing and Disclosure</h2>
                        <p className="text-slate-600 dark:text-slate-300 mb-4">
                        ...
                        <h2 className="text-2xl font-bold text-slate-900 dark:text-white mb-6">4. Data Security</h2>
                        <p className="text-slate-600 dark:text-slate-300 mb-8">
                            We implement appropriate technical and organizational security measures to protect your personal information against unauthorized access, alteration, disclosure, or destruction. However, no method of transmission over the internet or electronic storage is 100% secure.
                        </p>

                        <h2 className="text-2xl font-bold text-slate-900 dark:text-white mb-6">5. Data Retention</h2>
                        <p className="text-slate-600 dark:text-slate-300 mb-8">
                            We retain your personal information only for as long as necessary to fulfill the purposes outlined in this privacy policy, unless a longer retention period is required or permitted by law.
                        </p>

                        <h2 className="text-2xl font-bold text-slate-900 dark:text-white mb-6">6. Your Rights</h2>
                        <p className="text-slate-600 dark:text-slate-300 mb-4">
                        ...
                        <h2 className="text-2xl font-bold text-slate-900 dark:text-white mb-6">7. Cookies and Tracking Technologies</h2>
                        <p className="text-slate-600 dark:text-slate-300 mb-8">
                            We use cookies and similar tracking technologies to enhance your experience on our website. For more information about our use of cookies, please see our <a href="/cookie-policy" className="text-brand-600 dark:text-brand-400 hover:underline">Cookie Policy</a>.
                        </p>

                        <h2 className="text-2xl font-bold text-slate-900 dark:text-white mb-6">8. Third-Party Links</h2>
                        <p className="text-slate-600 dark:text-slate-300 mb-8">
                            Our website may contain links to third-party websites. We are not responsible for the privacy practices or content of these external sites. We encourage you to review the privacy policies of any third-party sites you visit.
                        </p>

                        <h2 className="text-2xl font-bold text-slate-900 dark:text-white mb-6">9. Children's Privacy</h2>
                        <p className="text-slate-600 dark:text-slate-300 mb-8">
                        ...
                        <h2 className="text-2xl font-bold text-slate-900 dark:text-white mb-6">10. Changes to This Privacy Policy</h2>
                        <p className="text-slate-600 dark:text-slate-300 mb-8">
                            We may update this privacy policy from time to time. We will notify you of any changes by posting the new privacy policy on this page and updating the "Last updated" date. We encourage you to review this privacy policy periodically.
                        </p>

                        <h2 className="text-2xl font-bold text-slate-900 dark:text-white mb-6">11. Contact Us</h2>
                        <p className="text-slate-600 dark:text-slate-300 mb-4">
                            If you have any questions about this privacy policy or our privacy practices, please contact us:
                        </p>
                        <div className="bg-slate-50 dark:bg-slate-900/60 p-6 rounded-lg mb-12">
                        ...
                        <div className="border-t border-slate-200 dark:border-slate-700 pt-12">
                            ...
                            <h2 className="text-2xl font-bold text-slate-900 dark:text-white mb-6">1. General Policy</h2>
                            <ul className="list-disc list-inside text-slate-600 dark:text-slate-300 mb-8 space-y-2">
                            ...
                            <h2 className="text-2xl font-bold text-slate-900 dark:text-white mb-6">2. Training & Certification Programs</h2>
                            <ul className="list-disc list-inside text-slate-600 dark:text-slate-300 mb-8 space-y-2">
                            ...
                            <h2 className="text-2xl font-bold text-slate-900 dark:text-white mb-6">3. Internship Programs</h2>
                            <ul className="list-disc list-inside text-slate-600 dark:text-slate-300 mb-8 space-y-2">
                            ...
                            <h2 className="text-2xl font-bold text-slate-900 dark:text-white mb-6">4. Projects & Consultancy Services</h2>
                            <ul className="list-disc list-inside text-slate-600 dark:text-slate-300 mb-8 space-y-2">
                            ...
                            <h2 className="text-2xl font-bold text-slate-900 dark:text-white mb-6">5. Payment Errors</h2>
                            <p className="text-slate-600 dark:text-slate-300 mb-8">
                                Any duplicate or failed transactions resulting in extra charges will be verified and refunded within 7–10 working days.
                            </p>

                            <h2 className="text-2xl font-bold text-slate-900 dark:text-white mb-6">6. Cancellation Requests</h2>
                            <ul className="list-disc list-inside text-slate-600 dark:text-slate-300 mb-8 space-y-2">
                            ...
                            <h2 className="text-2xl font-bold text-slate-900 dark:text-white mb-6">7. Processing Time</h2>
                            <p className="text-slate-600 dark:text-slate-300 mb-8">
                        ...
                        <div className="border-t border-slate-200 dark:border-slate-700 pt-12">
                            ...
                            <h2 className="text-2xl font-bold text-slate-900 dark:text-white mb-6">1. General Disclaimer</h2>
                            <ul className="list-disc list-inside text-slate-600 dark:text-slate-300 mb-8 space-y-2">
                            ...
                            <h2 className="text-2xl font-bold text-slate-900 dark:text-white mb-6">2. Certifications & Training</h2>
                            <ul className="list-disc list-inside text-slate-600 dark:text-slate-300 mb-8 space-y-2">
                            ...
                            <h2 className="text-2xl font-bold text-slate-900 dark:text-white mb-6">4. Projects & Consultancy</h2>
                            <ul className="list-disc list-inside text-slate-600 dark:text-slate-300 mb-8 space-y-2">
                            ...
                            <h2 className="text-2xl font-bold text-slate-900 dark:text-white mb-6">5. Third-Party Links</h2>
                            <p className="text-slate-600 dark:text-slate-300 mb-8">
                            ...
                            <h2 className="text-2xl font-bold text-slate-900 dark:text-white mb-6">6. Limitation of Liability</h2>
                            <ul className="list-disc list-inside text-slate-600 dark:text-slate-300 mb-8 space-y-2">
                            ...
                            <h2 className="text-2xl font-bold text-slate-900 dark:text-white mb-6">7. No Guarantee</h2>
                            <p className="text-slate-600 dark:text-slate-300 mb-8">
                            ...
                            <h2 className="text-2xl font-bold text-slate-900 dark:text-white mb-6">8. Contact Us</h2>
                            <p className="text-slate-600 dark:text-slate-300 mb-4">
